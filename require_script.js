// This file is part of the require_script.js
// 
// @license http://opensource.org/licenses/MIT
// @link https://github.com/joomimart/require_script
// @version 1.0.1
// @package require_script.js
// 
// For the full copyright and license information, please view the LICENSE
// file that was distributed with this source code.

// Учтите что уже должна быть объявлена переменная templates_lib - это путь к папке всех библиотек
// var templates_lib = '/templates/lib'

var templates_dir = templates_lib // Можно изменить значение в templates_lib или прописать путь здесь

// require_script
var require_script = templates_dir + '/require_script'
